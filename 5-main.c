...
int main(void)
{
    ...
    /* Check if nodes are roots */
    printf("Is root a root? %d\n", binary_tree_is_root(root));
    printf("Is left child a root? %d\n", binary_tree_is_root(left));
    printf("Is right child a root? %d\n", binary_tree_is_root(right));
